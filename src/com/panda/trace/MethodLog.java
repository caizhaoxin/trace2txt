...
public class MethodLog implements Comparable{
	...
	public String getMyFullName() {
		int rightPareIndex = record.m.getMethodSig().indexOf(')');
		String params = record.m.getMethodSig().substring(0, rightPareIndex+1);
		String returnType = record.m.getMethodSig().substring(rightPareIndex+1);
		return record.m.getMethodDescriptor()+"."+record.m.getMethodName()+" "+params+" "+returnType;
	}
